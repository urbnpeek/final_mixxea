...
// ─── VideoShowcase (inline — avoids git-tracking issues with a separate file) ───
...
function VideoShowcase() {
  ...
  }, [activeClip]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    <section className="relative bg-black overflow-hidden">
        ...
        <div className="relative h-full flex flex-col justify-between px-8 md:px-16 py-10 max-w-[1400px] mx-auto">
          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <span className="text-sm font-semibold uppercase tracking-widest text-white/70">{clip.label}</span>
            </motion.div>
      ...
      {/* Stats bar */}
      <div className="relative border-y border-white/[0.05]" style={{ background: 'linear-gradient(180deg,#060606 0%,#000 100%)' }}>
